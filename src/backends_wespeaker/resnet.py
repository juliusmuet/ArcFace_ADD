...
import backends_wespeaker.pooling_layers as pooling_layers
...
def ResNet18(feat_dim=80, embed_dim=256, pooling_func='TSTP', two_emb_layer=False):
...
def ResNet34(feat_dim=80, embed_dim=256, pooling_func='TSTP', two_emb_layer=False):
...
def ResNet50(feat_dim=80, embed_dim=256, pooling_func='TSTP', two_emb_layer=False):
...
def ResNet101(feat_dim=80, embed_dim=256, pooling_func='TSTP', two_emb_layer=False):
...
def ResNet152(feat_dim=80, embed_dim=256, pooling_func='TSTP', two_emb_layer=False):
...
def ResNet221(feat_dim=80, embed_dim=256, pooling_func='TSTP', two_emb_layer=False):
...
def ResNet293(feat_dim=80, embed_dim=256, pooling_func='TSTP', two_emb_layer=False):
